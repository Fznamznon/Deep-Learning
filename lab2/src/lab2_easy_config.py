...
first = mx.sym.FullyConnected(data=input, num_hidden=1000)
firstact = mx.sym.Activation(data=first, act_type='tanh')
second = mx.sym.FullyConnected(data=firstact, num_hidden=500)
secondact = mx.sym.Activation(data=second, act_type='tanh')
third = mx.sym.FullyConnected(data=secondact, num_hidden=250)
thirdact = mx.sym.Activation(data=third, act_type='tanh')
fc = mx.sym.FullyConnected(data=thirdact, num_hidden=2)
