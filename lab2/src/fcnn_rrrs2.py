...
first = mx.sym.FullyConnected(data=input, num_hidden=7500)
firstact = mx.sym.Activation(data=first, act_type='relu')
second = mx.sym.FullyConnected(data=firstact, num_hidden=2500)
secondact = mx.sym.Activation(data=second, act_type='relu')
third = mx.sym.FullyConnected(data=secondact, num_hidden=1000)
